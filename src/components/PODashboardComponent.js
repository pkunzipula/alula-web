  ...
  renderOverviewTableData() {
    return this.state.overview.map((overview) => {
      ...
      return (
        <Table.Row>
          <Table.Col>
            <strong>{propsMangaged}</strong>
          </Table.Col>
          <Table.Col>
            <strong>${totRevenue}</strong>
          </Table.Col>
          <Table.Col>
            <strong>${totLoses}</strong>
          </Table.Col>
          <Table.Col>
            <strong>{totServiceRequests}</strong>
          </Table.Col>
          <Table.Col>
            <a href="">
              <i class="fas fa-print mr-2"></i>Print Tax Form
            </a>
          </Table.Col>
        </Table.Row>
      );
            ...
            <div className="table-responsive">
              <div className="container text-center">
                <Table>
                  ...
                  <Table.Body>{this.renderOverviewTableData()}</Table.Body>
                </Table>
              </div>
            </div>
          </div>
        ...
        <Container className="mt-5">
          <div className="card">
            <div className="d-flex justify-content-between">
              ...
              <Link className="btn btn-sm btn-success m-3" to="/add-property">
            ...
            <div className="table-responsive">
              <div className="container text-center">
                <Table>
                  ...
                  <Table.Body>{this.renderPropertyTableData()}</Table.Body>
                </Table>
              </div>
            </div>
            <div className="container d-flex justify-content-center">
            ...
            <div className="table-responsive">
              <div className="container text-center">
                <Table>
                  ...
                  <Table.Body>{this.renderInvoiceTableData()}</Table.Body>
                </Table>
              </div>
            </div>
            <div className="container d-flex justify-content-center">
